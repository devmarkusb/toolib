...
/** NOTE: This file remains just as a documentation. It doesn't make much sense. Every dll should use its own
    export define.
    Usage: The following steps are for a DLL as intended target. The absolute same applies for a LIB - you just
...
//! TOO_BUILDANDUSE_DLL must be defined when you compile a library as DLL and also when you use it.
