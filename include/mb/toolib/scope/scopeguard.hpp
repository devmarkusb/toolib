...
mb::too::ScopeGuard guardSVPush = mb::too::MakeObjGuard(svec, &std::vector<std::string>::pop_back);
...
If you like to transfer a parameter by reference, use mb::too::byRef(some_variable) instead of some_variable as parameter.
