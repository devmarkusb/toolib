...
#pragma pop_macro("new")
	...
	public:
		ScopeGuardImpl2(Fct fct, Para1 para1, Para2 para2)
			: m_fct(fct), m_para1(para1), m_para2(para2){}
		~ScopeGuardImpl2()
		{
			if (m_bRollback)
			{
				try { m_fct(m_para1, m_para2); }
				catch (...) {}
			}
		}
	private:
	...
	public:
		ObjScopeGuardImpl1(Obj& obj, MemFct memFct, Para1 para1)
			: m_obj(obj), m_memFct(memFct), m_para1(para1){}
		~ObjScopeGuardImpl1()
		{
			if (m_bRollback)
			{
				try { (m_obj.*m_memFct)(m_para1); }
				catch (...) {}
			}
		}
	private:
	...
	public:
		...
		~ObjScopeGuardImpl2()
		{
			if (m_bRollback)
			{
				try { (m_obj.*m_memFct)(m_para1, m_para2); }
				catch (...) {}
			}
		}
	private:
	...
	template <typename Fct, typename Para1> inline
	...
	template <typename Fct, typename Para1, typename Para2> inline
	...
	template <class Obj, typename MemFct> inline
	...
	template <class Obj, typename MemFct, typename Para1> inline
	...
	template <class Obj, typename MemFct, typename Para1, typename Para2> inline
	ObjScopeGuardImpl2<Obj, MemFct, Para1, Para2>
	MakeObjGuard(Obj& obj, MemFct memFct, Para1 para1, Para2 para2)
	{
